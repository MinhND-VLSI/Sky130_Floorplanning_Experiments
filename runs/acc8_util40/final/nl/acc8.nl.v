module acc8 (clk,
 ...
 sky130_fd_sc_hd__inv_2 _91_ (.A(net9),
    .Y(_07_));
 sky130_fd_sc_hd__dfrtp_1 _92_ (.CLK(clknet_1_0__leaf_clk),
    .D(\adder.low.p[0] ),
    .RESET_B(_00_),
    .Q(net10));
 sky130_fd_sc_hd__dfrtp_1 _93_ (.CLK(clknet_1_0__leaf_clk),
    .D(\adder.low.sum[1] ),
    .RESET_B(_01_),
    .Q(net11));
 sky130_fd_sc_hd__dfrtp_1 _94_ (.CLK(clknet_1_0__leaf_clk),
    .D(\adder.low.sum[2] ),
    .RESET_B(_02_),
    .Q(net12));
 sky130_fd_sc_hd__dfrtp_1 _95_ (.CLK(clknet_1_1__leaf_clk),
    .D(\adder.low.sum[3] ),
    .RESET_B(_03_),
    .Q(net13));
 sky130_fd_sc_hd__dfrtp_1 _96_ (.CLK(clknet_1_0__leaf_clk),
    .D(\adder.high.sum[0] ),
    .RESET_B(_04_),
    .Q(net14));
 sky130_fd_sc_hd__dfrtp_1 _97_ (.CLK(clknet_1_1__leaf_clk),
    .D(\adder.high.sum[1] ),
    .RESET_B(_05_),
    .Q(net15));
 sky130_fd_sc_hd__dfrtp_1 _98_ (.CLK(clknet_1_1__leaf_clk),
    .D(\adder.high.sum[2] ),
    .RESET_B(_06_),
    .Q(net16));
 sky130_fd_sc_hd__dfrtp_1 _99_ (.CLK(clknet_1_1__leaf_clk),
    .D(\adder.high.sum[3] ),
    .RESET_B(_07_),
    .Q(net17));
 ...
 sky130_fd_sc_hd__decap_8 FILLER_13_70 ();
