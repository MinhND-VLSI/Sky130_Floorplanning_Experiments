...
set_output_delay 4.0000 -clock [get_clocks {clk}] -add_delay [get_ports {acc[0]}]
set_output_delay 4.0000 -clock [get_clocks {clk}] -add_delay [get_ports {acc[1]}]
set_output_delay 4.0000 -clock [get_clocks {clk}] -add_delay [get_ports {acc[2]}]
set_output_delay 4.0000 -clock [get_clocks {clk}] -add_delay [get_ports {acc[3]}]
set_output_delay 4.0000 -clock [get_clocks {clk}] -add_delay [get_ports {acc[4]}]
set_output_delay 4.0000 -clock [get_clocks {clk}] -add_delay [get_ports {acc[5]}]
set_output_delay 4.0000 -clock [get_clocks {clk}] -add_delay [get_ports {acc[6]}]
set_output_delay 4.0000 -clock [get_clocks {clk}] -add_delay [get_ports {acc[7]}]
###############################################################################
# Environment
###############################################################################
set_load -pin_load 0.0334 [get_ports {acc[7]}]
set_load -pin_load 0.0334 [get_ports {acc[6]}]
set_load -pin_load 0.0334 [get_ports {acc[5]}]
set_load -pin_load 0.0334 [get_ports {acc[4]}]
set_load -pin_load 0.0334 [get_ports {acc[3]}]
set_load -pin_load 0.0334 [get_ports {acc[2]}]
set_load -pin_load 0.0334 [get_ports {acc[1]}]
set_load -pin_load 0.0334 [get_ports {acc[0]}]
