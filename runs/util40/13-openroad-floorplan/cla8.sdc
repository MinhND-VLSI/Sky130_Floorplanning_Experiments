...
set_input_delay 4.0000 -clock [get_clocks {__VIRTUAL_CLK__}] -add_delay [get_ports {cin}]
set_output_delay 4.0000 -clock [get_clocks {__VIRTUAL_CLK__}] -add_delay [get_ports {cout}]
set_output_delay 4.0000 -clock [get_clocks {__VIRTUAL_CLK__}] -add_delay [get_ports {sum[0]}]
set_output_delay 4.0000 -clock [get_clocks {__VIRTUAL_CLK__}] -add_delay [get_ports {sum[1]}]
set_output_delay 4.0000 -clock [get_clocks {__VIRTUAL_CLK__}] -add_delay [get_ports {sum[2]}]
set_output_delay 4.0000 -clock [get_clocks {__VIRTUAL_CLK__}] -add_delay [get_ports {sum[3]}]
set_output_delay 4.0000 -clock [get_clocks {__VIRTUAL_CLK__}] -add_delay [get_ports {sum[4]}]
set_output_delay 4.0000 -clock [get_clocks {__VIRTUAL_CLK__}] -add_delay [get_ports {sum[5]}]
set_output_delay 4.0000 -clock [get_clocks {__VIRTUAL_CLK__}] -add_delay [get_ports {sum[6]}]
set_output_delay 4.0000 -clock [get_clocks {__VIRTUAL_CLK__}] -add_delay [get_ports {sum[7]}]
###############################################################################
# Environment
###############################################################################
